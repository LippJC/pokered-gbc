...
; entries correspond to PAL_* constants
	...
	RGB 31,31,31, 24,00,00, 05,08,17, 00,00,00 ; PAL_VIRIDIAN (Re-tooled for Porygon)
	RGB 31,31,31, 31,20,00, 25,06,00, 00,00,00 ; PAL_PEWTER (Re-tooled for Dragonite)
...
ENDC
	...
	RGB 31,31,31, 29,19,13, 16,00,25, 00,00,00 ; PAL_MEWMON (Re-tooled for Blue/Gary)
	RGB 31,31,31, 16,18,31, 00,01,25, 00,00,00 ; PAL_BLUEMON
	RGB 31,31,31, 31,21,00, 31,00,00, 00,00,00 ; PAL_REDMON  
